...
body {
        ...
        /* Style for the employer container */
        .employer-container {
            display: flex;
            max-width: 700px;
            margin: 10px;
        ...
        /* Style for the employer photo/logo */
        .employer-photo img {
            max-width: 80%;
            height: auto;
        ...
        /* Style for the container holding both sections */
        .container-wrapper {
            display: flex;
      ...
      <div class="container-wrapper">
        <div class="employer-container">
            ...
            <div class="employer-details">
                ...
                <p>Avaliable Job Post : ${employer.avaliable_jobpost}</p>
            </div>
        </div>
      </div>
