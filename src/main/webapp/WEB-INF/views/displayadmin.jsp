...
<body>
		...
		<tbody>
			<c:forEach var="admin" items="${admins}">
				<tr>
					...
					<td> <button onclick="openDeleteModal('${admin.id}')">Delete</button></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	...
	<div class="txtpos">
		<form:form action="addadmin" method="post" modelAttribute="admin">
			<div class="loginclass" id="position">
				<div>
					<h2 class="header">Add New Admin</h2>
				</div>
				...
				<div>
					...
					<form:errors path="email" class="errorcolor"></form:errors>
				</div>

				<div>
					<form:input path="password" placeholder="Enter Password"
						type="password"></form:input>
					<form:errors path="password" class="errorcolor"></form:errors>
				</div>
				...
				<div>
					...
					<form:errors path="role_id" class="errorcolor"></form:errors>
				</div>
					<br>
				<div>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        ...
        fetch('deleteadmin/' + adminIdToDelete, {
            method: 'GET'
        })
        .then(response => {
            if (response.ok) {
