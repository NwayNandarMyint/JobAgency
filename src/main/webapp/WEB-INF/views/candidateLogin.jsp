...
<style type="text/css">
        .background-container {
            ...
            background-color: MediumSpringGreen; /* Dark background color */
    ...
    <div class="dashboard">
      ...
      <div class="ui-row-2">
        ...
        <div class="background-container">
            <form:form action="/Job_agency/candidate/login" method="post" modelAttribute="login">
            <form:errors path="*" cssClass="text-danger" element="div"></form:errors>
                <div class="container">
                    <div>
                        <h2 class="header">Candidate Login Here!</h2>
                    </div>
					...
					<div>
						<form:input path="password" placeholder="Enter Your Password" type="password"></form:input>
                    ...
                    <div>
                    	<p>You have't account?  <a href="/Job_agency/candidate/addcandidate">Register Now</a></p>
                    </div>
                     <div>
