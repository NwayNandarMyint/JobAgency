...
<body>
		...
		<tbody>
			<c:forEach var="language" items="${languages}">
				<tr>
					...
					<td> <button onclick="openDeleteModal('${language.id}')">Delete</button></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	...
	<div class="txtpos">
		...
		<form:form action="addsimplelanguage" method="post"
			modelAttribute="lan">
			<div class="loginclass" id="position">
				<div>
					<h2 class="header">Add New Language</h2>
				</div>

				<div class="errorcolor">${error}</div>

				<div>
					<form:input path="name" placeholder="Enter Language"></form:input>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        ...
        fetch('deletesimplelanguage/' + languageIdToDelete, {
            method: 'GET'
        })
        .then(response => {
            if (response.ok) {
