      ...
      <div class="ui-row-2">
        ...
        <div class="main-content">
          ...
          <hr>
			...
			<!--Update Employer -->
			<div class="container">
				<form:form action="/Job_agency/employer/updateemployer" method="post" modelAttribute="updateemployer" enctype="multipart/form-data">
							<div>
								<h2 class="header">Update Profile</h2>
							</div>
							<div>
								<form:label path="name">Enter Employer Update Name</form:label>
								<form:input path="name" value="${employer.name}"></form:input>
								<form:errors path="name" cssClass="text-danger"></form:errors>
							</div>
							<div>
								 <form:label path="email">Enter Employer Update E-Mail</form:label>
								<form:input path="email" value="${employer.email}"></form:input>
								<form:errors path="email" cssClass="text-danger"></form:errors>
							</div>
							<div>
								<form:label path="password">Enter Want To Change Password</form:label>
								<form:input path="password" value="${employer.password}"></form:input>
								<form:errors path="password" cssClass="text-danger"></form:errors>
							</div> 
							<div>
								<form:label path="phone_number">Enter Want To Change Phone Number</form:label>
								<form:input  path="phone_number" value="${employer.phone_number}"></form:input>
								<form:errors path="phone_number" cssClass="text-danger"></form:errors>
							</div>
							<div>
								<form:label path="logo">Choose Want To Change Profile Photo</form:label>
				...
				<div class="popup" id="popup">
	                ...
	                <p>Your Profile Update is Successful!</p>
	                <a href="/Job_agency/employer/displayemployer/"><button type="button">Ok</button></a>
           		</div>
			</div>
