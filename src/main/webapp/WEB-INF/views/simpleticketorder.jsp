            ...
            <c:forEach var="order" items="${ticketorders}">
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="/Job_agency/admin/confirmsimpleticket?em_id=${order.employer_id}&&tc_id=${order.ticket_id}&&employer_ticketid=${order.id}" class="add-button">Accept</a>
                        <a href="/Job_agency/admin/cancelsimpleticket?employer_ticketid=${order.id}" class="delete-button">Reject</a>
                    </td>
                     <c:choose>
