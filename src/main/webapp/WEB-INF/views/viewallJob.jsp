        ...
        <div class="main-content">
          ...
          <div class="header">
            ...
            <div class="clay-category">
              ...
              <p><a href="/Job_agency/candidate/userHome" style="color: green; text-decoration: none;">Go to Home </a></p>
            </div>
			...
			<c:forEach var="post" items="${jobposts}">
				<tr>
					...
					<td class="action-buttons">
                        <a href="/Job_agency/candidatecv/${post.id}" class="add-button">Send CV</a>
                    </td>
				</tr>
			</c:forEach>
		</tbody>
